        ...
        <div id="layoutAuthentication">
            <div id="layoutAuthentication_content">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a class="small" href="password.html">Recordar contraseña?</a>
                ...
                <footer class=" bg-light">
                    <div>
                          <a href="https://tics-service.com/siriuschoice/" target="_blank"> Elaborado por:
                            Sirius Mexico
                        </a>
                    </div>
				</footer>
